...
export const SECTOR_PRESETS: Record<SectorKey, SectorPreset[]> = {
  restaurant: [
    ...
    { emoji: '❌', label: 'Pas de lot cette fois', color: '#78909C', isWinning: false, suggestedStock: 0 },
  ],
  cafe_bar: [
...
export const WHEEL_TEMPLATES = [
  ...
  { emoji: '❌', label: 'Pas de lot cette fois', color: '#78909C', isWinning: false },
...
export const TEXTS = {
  ...
  crossPromo: {
    navLabel: 'Réseau local',
    navBadge: 'Beta',
    pageTitle: 'Réseau local',
    pageSubtitle: 'Partagez vos lots avec d\'autres commerces de votre ville',
    activationTitle: 'Activation',
    activationDescription: 'Partagez vos lots avec d\'autres commerces de votre ville pour faire découvrir votre activité',
    activationEnabled: 'Réseau local activé',
    activationDisabled: 'Réseau local désactivé',
    partnersCount: 'partenaires actifs à',
    cityLabel: 'Ville',
    cityPlaceholder: 'Ex: Lausanne',
    offersTitle: 'Mes lots partagés',
    offersDescription: 'Choisissez les lots à partager avec le réseau',
    offersStockLabel: 'Stock cross-promo/mois',
    offersValidityNote: 'Validité fixe : 15 jours pour tous les lots partagés',
    networkTitle: 'Mon réseau',
    networkEmpty: 'Aucun partenaire pour le moment',
    networkEmptyInvite: 'Invitez d\'autres commerçants !',
    statsGiven: 'Lots offerts ce mois',
    statsReceived: 'Lots reçus ce mois',
    statsClaimed: 'Lots réclamés',
    partnerPrizeTitle: 'Vous avez gagné chez',
  ...
  group: {
    navLabel: 'Mes établissements',
    navBadge: 'New',
    pageTitle: 'Mes établissements',
    pageSubtitle: 'Gérez vos lots partagés entre vos différents établissements',
    createTitle: 'Créer un groupe',
    createDescription: 'Regroupez vos établissements pour partager des lots entre eux. Chaque client qui tourne la roue dans un de vos établissements peut gagner un lot d\'un autre établissement du groupe.',
    createCta: 'Créer mon groupe',
    groupNameLabel: 'Nom du groupe',
    groupNamePlaceholder: 'Ex : Groupe Hôtel du Lac',
    membersTitle: 'Mes établissements',
    addLocationCta: 'Ajouter un établissement',
    offersTitle: 'Lots partagés au groupe',
    offersDescription: 'Choisissez les lots à partager avec vos autres établissements',
    statsTitle: 'Statistiques du groupe',
    statsGiven: 'Lots offerts au groupe',
    statsReceived: 'Lots reçus du groupe',
    statsClaimed: 'Lots réclamés',
    switcherLabel: 'Changer d\'établissement',
    requiresGrowth: 'Chaque établissement nécessite un abonnement Growth ou Pro',
    groupPrizeTitle: 'Vous avez gagné chez',
    groupPrizeValidity: 'jours pour en profiter',
  },
  onboarding: {
